...
class LargeWeatherWidget : GlanceAppWidget(errorUiLayout = R.layout.widget_error_layout) {
    ...
    Column(
        ...
        Row(
            ...
            Column {
                ...
                Text(
                    text = "Feels ${data.feelsLike.roundToInt()}° · ${data.humidity}% humidity",
                    style = TextStyle(
        ...
        // Hourly forecast strip (6 hours)
        Row(
            modifier = GlanceModifier.fillMaxWidth(),
            horizontalAlignment = Alignment.CenterHorizontally
        ) {
            data.hourlyForecasts.take(6).forEachIndexed { index, hourly ->
        ...
        // 5-day forecast
        data.dailyForecasts.take(5).forEach { daily ->
            Row(
